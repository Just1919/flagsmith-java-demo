...
public class Main {
    ...
    private static void populateDummyData() {
        ...
        books.add(new Book("4", "The Kite ", "DJAKAS Yawo Justin ", "30.99"));
        books.add(new Book("5", "The  Runner", "Pr. Ing. DJAKAS", "30.99"));
    }
    public static void main(String[] args) throws Exception {
        HttpServer server = HttpServer.create(new InetSocketAddress(8000), 0);
        populateDummyData();
        fsClient = getFlagsmithClient(); //Initialisation du Client
